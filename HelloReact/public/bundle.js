...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: necMessage }), document.getElementById('app'));
	...
	var Greeter = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(GreeterForm, { onUpdate: this.handleNewUpdate })
	        );
	    }
	});
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', ref: 'name', placeholder: 'EnterName' })
	            ),
	            React.createElement(
	                'div',
	                null,
